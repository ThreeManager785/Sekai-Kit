...
private struct APITests {
    ...
    func testDataLocalization() async throws {
        var data = SekaiAPI.LocalizedData<Int>(jp: nil, en: nil, tw: nil, cn: nil, kr: nil)
        let allLocales = SekaiAPI.Locale.allCases
        ...
        data._set(42, forLocale: SekaiAPI.preferredLocale)
        #expect(data.forPreferredLocale(allowsFallback: false) != nil)
        #expect(data.forPreferredLocale(allowsFallback: true) != nil)
        #expect(data.availableInPreferredLocale())
        #expect(data.availableLocale(prefer: nil) == SekaiAPI.preferredLocale)
    ...
    func testBand() async throws {
        var bands = try #require(await SekaiAPI.Band.all())
        ...
        bands = try #require(await SekaiAPI.Band.main())
        #expect(!bands.isEmpty)
        for band in bands {
            #expect(band.id > 0, .init(band))
            #expect(band.bandName.availableLocale() != nil, .init(band))
    ...
    func testCard() async throws {
        ...
        let cards = try #require(await SekaiAPI.Card.all())
        ...
        let card = try #require(await SekaiAPI.Card.detail(of: testingCardID))
    ...
    func testCharacter() async throws {
        ...
        let characters = try #require(await SekaiAPI.Character.all())
        ...
        let bdayCharacters = try #require(await SekaiAPI.Character.allBirthday())
        ...
        let character = try #require(await SekaiAPI.Character.detail(of: 39))
    ...
    func testCostume() async throws {
        ...
        let costumes = try #require(await SekaiAPI.Costume.all())
        ...
        let costume = try #require(await SekaiAPI.Costume.detail(of: testingCostumeID))
    ...
    func testEvent() async throws {
        ...
        let events = try #require(await SekaiAPI.Event.all())
        ...
        let event = try #require(await SekaiAPI.Event.detail(of: testingEventID))
