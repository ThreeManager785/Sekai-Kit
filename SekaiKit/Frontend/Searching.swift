...
extension SekaiFrontend {
    ...
    public protocol Searchable: Identifiable {
        ...
        var _searchLocalizedStrings: [SekaiAPI.LocalizedData<String>] { get }
        var _searchIntegers: [Int] { get }
        var _searchLocales: [SekaiAPI.Locale] { get }
        var _searchBands: [SekaiAPI.Bands.Band] { get }
        var _searchAttributes: [SekaiAPI.Attribute] { get }
    }
}

extension SekaiFrontend.Searchable {
...
extension Array where Element: SekaiFrontend.Searchable {
    ...
    ///
    ///     When it's set to an empty array, SekaiKit doesn't apply
    ///     locale-specific improments to searching.
    ///     When it's set to `nil`, SekaiKit determines
...
//                    }
            ...
            tokenLoop: for token in tokens {
                ...
                let server: SekaiAPI.Locale? = switch token {
                ...
                let attribute: SekaiAPI.Attribute? = switch token {
...
extension SekaiAPI.Cards.PreviewCard: SekaiFrontend.Searchable {
    public var _searchLocalizedStrings: [SekaiAPI.LocalizedData<String>] {
        [
            self.cardName,
    ...
    private var _character: SekaiAPI.Characters.PreviewCharacter? {
        PreCache.current.characters.first {
            $0.id == self.characterID
        }
    }
}
extension SekaiAPI.Comics.Comic: SekaiFrontend.Searchable {
    public var _searchLocalizedStrings: [SekaiAPI.LocalizedData<String>] {
    ...
    private var _characters: [SekaiAPI.Characters.PreviewCharacter] {
        PreCache.current.characters.filter {
            self.characterIDs.contains($0.id)
        }
    }
}
extension SekaiAPI.Costumes.PreviewCostume: SekaiFrontend.Searchable {
    public var _searchLocalizedStrings: [SekaiAPI.LocalizedData<String>] {
        [
            self.description,
            _character?.characterName,
    ...
    public var _character: SekaiAPI.Characters.PreviewCharacter? {
        PreCache.current.characters.first {
            $0.id == self.characterID
        }
    }
}
extension SekaiAPI.Events.PreviewEvent: SekaiFrontend.Searchable {
    public var _searchStrings: [String] {
...
extension SekaiAPI.Gachas.PreviewGacha: SekaiFrontend.Searchable {
    public var _searchStrings: [String] {
...
extension SekaiAPI.LoginCampaigns.PreviewCampaign: SekaiFrontend.Searchable {
    public var _searchStrings: [String] {
...
extension SekaiAPI.Songs.PreviewSong: SekaiFrontend.Searchable {
    public var _searchStrings: [String] {
