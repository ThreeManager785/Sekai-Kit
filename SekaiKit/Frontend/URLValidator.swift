...
extension SekaiFrontend {
    /// Validate URLs from SekaiKit.
    ///
    /// - IMPORTANT:
    ///     This class should only be used to validate URLs from SekaiKit.
    ///     It may give false results for other URLs.
    public final class URLValidator: @unchecked Sendable, ObservableObject {
        /// Validates reachability of a URL from SekaiKit.
        /// - Parameter url: A URL from SekaiKit for validation.
        /// - Returns: Whether the provided URL is reachable.
        ///
        /// - IMPORTANT:
        ///     This function should only be used to validate URLs from SekaiKit.
        ///     It may give false results for other URLs.
        ...
        public init(validating urls: [URL]) {
            ...
            self.validationTask = Task {
                ...
                for url in urls where await SekaiFrontend.URLValidator.reachability(of: url) {
