    ...
    public enum MiracleTickets {
        ...
        public static func extendedList() async -> [ExtendedMiracleTicket]? {
            let groupResult = await withTasksResult {
                await SekaiAPI.MiracleTickets.all()
            } _: {
...
extension SekaiFrontend.MiracleTickets {
    public struct ExtendedMiracleTicket: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        public var ticket: SekaiAPI.MiracleTickets.MiracleTicket
        public var cards: SekaiAPI.LocalizedData<[SekaiAPI.Cards.PreviewCard]>
