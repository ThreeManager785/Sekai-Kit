...
extension SekaiFrontend {
    ...
    public enum Songs {
        ...
        public static func list() async -> [PreviewSong]? {
            guard let songs = await SekaiAPI.Songs.all() else { return nil }
            return songs
        }
        
        public static func allMeta(
            with skill: SekaiAPI.Skills.Skill,
        ...
        public static func meta(
            for song: SekaiAPI.Songs.PreviewSong,
            with skill: SekaiAPI.Skills.Skill,
            in locale: SekaiAPI.Locale,
            skillLevel: Int,
            perfectRate: Double,
            downtime: Double,
            fever: Bool
        ) async -> [SekaiAPI.Songs.DifficultyType: Meta]? {
            guard let meta = await SekaiAPI.Songs.meta() else { return nil }
            
            var result = [SekaiAPI.Songs.DifficultyType: Meta]()
        ...
        public static func _meta(
            _ meta: SekaiAPI.Songs.SongMeta,
            for song: PreviewSong,
            of difficulty: SekaiAPI.Songs.DifficultyType,
            with skill: SekaiAPI.Skills.Skill,
            in locale: SekaiAPI.Locale,
            skillLevel: Int,
            perfectRate: Double,
        ...
        public static func extendedInformation(of id: Int) async -> ExtendedSong? {
            let groupResult = await withTasksResult {
                await SekaiAPI.Songs.detail(of: id)
            } _: {
            ...
            let pseudoSkill = SekaiAPI.Skills.Skill(
                id: -0x0527,
            ...
            func relatedEvents(for locale: SekaiAPI.Locale) -> [PreviewEvent]? {
...
extension SekaiFrontend.Songs {
    public typealias PreviewSong = SekaiAPI.Songs.PreviewSong
    public typealias Song = SekaiAPI.Songs.Song
    
    public struct Meta: Sendable, Hashable, SekaiCache.Cacheable {
        public var id: Int
    ...
    public struct SongWithMeta: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
    ...
    public struct ExtendedSong: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        public var song: Song
        public var band: SekaiAPI.Bands.Band?
        public var events: SekaiAPI.LocalizedData<[SekaiAPI.Events.PreviewEvent]>
        public var meta: [SekaiAPI.Songs.DifficultyType: Meta]
        public var metaFever: [SekaiAPI.Songs.DifficultyType: Meta]
...
extension SekaiFrontend.Songs.ExtendedSong {
    @inlinable
    public init?(id: Int) async {
        if let song = await SekaiFrontend.Songs.extendedInformation(of: id) {
            self = song
        } else {
            return nil
        }
...
extension SekaiFrontend.Songs {
    public struct Lyrics: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        public var id: Int
        ...
        public struct LyricLine: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
            public var id: UUID = UUID()
            public var original: String
            public var translations: SekaiAPI.LocalizedData<String>
            public var ruby: Ruby?
            public var partialStyle: [ClosedRange<Int>: Style]
            
            public struct Ruby: Sendable, Hashable, SekaiCache.Cacheable {
                public var romaji: String
                public var kana: String
            }
        }
        
        public struct Style: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
            public var id: UUID = UUID()
            ...
            public struct Stroke: Sendable, Hashable, SekaiCache.Cacheable {
                public var color: Color
                public var width: CGFloat
                public var radius: CGFloat
            }
            public struct Shadow: Sendable, Hashable, SekaiCache.Cacheable {
                public var color: Color
                public var x: CGFloat
                public var y: CGFloat
                public var blur: CGFloat
            }
            public struct MaskLine: Sendable, Hashable, SekaiCache.Cacheable {
                public var color: Color
                public var width: CGFloat
        ...
        public struct Metadata: Sendable, Hashable, SekaiCache.Cacheable {
            public var annotation: String?
            public var legends: [Legend]
            
            public struct Legend: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
                public var id: UUID = UUID()
                public var color: Color
                public var text: SekaiAPI.LocalizedData<String>
            }
        }
    }
}
...
extension SekaiFrontend.Songs {
    public enum _NeoSongMatchResult: Sendable, Hashable, SekaiCache.Cacheable {
        case success([MatchItem])
        case failure(String)
        case expectedEmpty
        
        public struct MatchItem: Codable, Hashable, Sendable, SekaiCache.Cacheable {
