...
public final class SekaiStoryBuilder: Sendable {
    public let locale: SekaiAPI.Locale
    
    public init(for locale: SekaiAPI.Locale) {
        self.locale = locale
    }
...
extension SekaiStoryBuilder {
    public enum Conversion {
        ...
        public static func zeileIR(
            fromBandori asset: SekaiAPI.Misc.StoryAsset,
