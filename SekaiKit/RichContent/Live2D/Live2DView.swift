...
public struct Live2DView<Placeholder: View, ErrorView: View>: View {
    ...
    @inlinable
    public init(
        costume: SekaiAPI.Costumes.PreviewCostume,
    ...
    @inlinable
    public init(
        costume: SekaiAPI.Costumes.Costume,
        placeholder: @escaping () -> Placeholder = { EmptyView() },
        errorView: @escaping () -> ErrorView = { Image(systemName: "exclamationmark.triangle.fill").foregroundStyle(.yellow) }
    ) {
        self.init(
    ...
    @inlinable
    public init(
        costume: SekaiAPI.Characters.SeasonCostume,
        placeholder: @escaping () -> Placeholder = { EmptyView() },
        errorView: @escaping () -> ErrorView = { Image(systemName: "exclamationmark.triangle.fill").foregroundStyle(.yellow) }
    ) {
        self.init(
...
public struct Live2DMotion: Sendable, Hashable {
    ...
    internal var preload: SekaiCache.PreloadDescriptor<String>
...
private func setupWebView(
    ...
    func textureArrayLiteral(from preloads: [SekaiCache.PreloadDescriptor<String>]) async -> String {
        var paths = [String]()
