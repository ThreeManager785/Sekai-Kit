...
private func compileNewsContent(
    _ content: SekaiAPI.News.Item.Content,
    locale: Locale,
...
private func compileContentSection(
    _ section: SekaiAPI.News.Item.Content.ContentDataSection,
    locale: Locale,
    dateFormatter: DateFormatter
) -> String {
    switch section {
...
private func compileBulletList(
    _ contents: [[SekaiAPI.News.Item.Content.ContentDataSection]],
    locale: Locale,
    dateFormatter: DateFormatter
) -> String {
    var result = ""
...
private func parseLinkTarget(_ target: String, data: String) -> String {
    switch target {
    case "live2d-asset": "https://bestdori.com/tool/live2d/asset/\(SekaiAPI.preferredLocale.rawValue)/\(data)"
    case "story-asset": "https://bestdori.com/tool/storyviewer/asset/\(SekaiAPI.preferredLocale.rawValue)/\(data)"
    case "asset-single": "https://bestdori.com/tool/explorer/asset/\(SekaiAPI.preferredLocale.rawValue)/\(data)"
