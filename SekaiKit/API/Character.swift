...
extension SekaiAPI {
    ...
    /// See ``Character/nickname`` for more details.
    ///
...
extension SekaiAPI.Characters {
    /// Represent simplified data of a character.
    public struct PreviewCharacter: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        /// A unique ID of character.
        public var id: Int
        /// Type of character.
        public var characterType: CharacterType
        /// Localized name of character.
        public var characterName: SekaiAPI.LocalizedData<String>
        ...
        public var nickname: SekaiAPI.LocalizedData<String>
        ...
        internal init(
            id: Int,
            characterType: CharacterType,
            characterName: SekaiAPI.LocalizedData<String>,
            nickname: SekaiAPI.LocalizedData<String>,
            bandID: Int?,
            color: Color?,
    ...
    public struct BirthdayCharacter: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        /// A unique ID of character.
        public var id: Int
        /// Localized name of character.
        public var characterName: SekaiAPI.LocalizedData<String>
    ...
    public struct Character: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        /// A unique ID of character.
        public var id: Int
        /// Type of character.
        public var characterType: CharacterType
        ...
        public var firstName: SekaiAPI.LocalizedData<String>
        /// Localized last name of character.
        public var lastName: SekaiAPI.LocalizedData<String>
        /// Localized nickname of character.
        ///
        /// Only few characters are associateed with a nickname,
        /// mainly in *RAISE A SUILEN*, such as Chiyu has a nickname *CHU²*.
        ...
        internal init(
            ...
            characterType: CharacterType,
            characterName: SekaiAPI.LocalizedData<String>,
            firstName: SekaiAPI.LocalizedData<String>,
            lastName: SekaiAPI.LocalizedData<String>,
            nickname: SekaiAPI.LocalizedData<String>,
            bandID: Int?,
            color: Color?,
        ...
        public struct Profile: Sendable, Hashable, SekaiCache.Cacheable {
            /// Localized name of character's voice actor.
            public var characterVoice: SekaiAPI.LocalizedData<String>
            /// Localized favorite food of character.
            public var favoriteFood: SekaiAPI.LocalizedData<String>
            /// Localized hated food of character.
            public var hatedFood: SekaiAPI.LocalizedData<String>
            /// Localized hobby of character.
            public var hobby: SekaiAPI.LocalizedData<String>
            /// Localized self-introduction of character.
            public var selfIntroduction: SekaiAPI.LocalizedData<String>
            /// Localized school name of character.
            public var school: SekaiAPI.LocalizedData<String>
            /// Localized class in school which the character in.
            public var schoolClass: SekaiAPI.LocalizedData<String> // named "schoolCls" in JSON, we use "schoolClass" to make it clear
            /// Localized school year which the character in.
            public var schoolYear: SekaiAPI.LocalizedData<String>
            /// The part of character works in band.
            public var part: Part
            /// Birthday of character.
            public var birthday: Date // String(JSON) -> Date(Swift)
            /// Constellation of character.
            public var constellation: SekaiAPI.Constellation
            /// Height of character, in *centimeter*.
            public var height: Int
            
            /// Represent a part in bands.
            public enum Part: String, Sendable, Hashable, SekaiCache.Cacheable {
                case vocal
                case keyboard
                case guitar
    ...
    ///
    /// - SeeAlso: Learn more about *main band* in ``SekaiAPI/Band/main()``.
    public enum CharacterType: String, Sendable, Hashable, SekaiCache.Cacheable {
        case unique
        case common
        case another
    }
    ...
    public struct SeasonCostume: Sendable, Hashable, SekaiCache.Cacheable {
        ...
        public enum CostumeType: String, Sendable, Hashable, SekaiCache.Cacheable {
            case casual = "CASUAL"
            case uniform = "UNIFORM"
        }
        public enum SeasonCostumeType: String, Sendable, Hashable, SekaiCache.Cacheable {
...
extension SekaiAPI.Characters.PreviewCharacter {
    public init(_ full: SekaiAPI.Characters.Character) {
        self.init(
            id: full.id,
...
extension SekaiAPI.Characters.BirthdayCharacter {
    public init?(_ full: SekaiAPI.Characters.Character) {
...
extension SekaiAPI.Characters.Character {
    @inlinable
    public init?(id: Int) async {
        if let character = await SekaiAPI.Characters.detail(of: id) {
            self = character
        } else {
            return nil
        }
    ...
    @inlinable
    public init?(preview: SekaiAPI.Characters.PreviewCharacter) async {
        await self.init(id: preview.id)
    }
    @inlinable
    public init?(preview: SekaiAPI.Characters.BirthdayCharacter) async {
        await self.init(id: preview.id)
    }
}
