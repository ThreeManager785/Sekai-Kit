                ...
                let task = Task.detached(priority: .userInitiated) {
                    ...
                    for (key, value) in respJSON {
                        let notes = value["notes"].map {
                            (key: SekaiAPI.Songs.DifficultyType(rawValue: Int($0.0)!) ?? .easy,
                             value: $0.1.intValue)
                ...
                let task = Task.detached(priority: .userInitiated) {
                    ...
                    return Song(
                        ...
                        difficulty: respJSON["difficulty"].map {
                            var publishedAt: SekaiAPI.LocalizedData<Date>?
                            ...
                            return (
                                key: SekaiAPI.Songs.DifficultyType(rawValue: Int($0.0)!) ?? .easy,
                                value: SekaiAPI.Songs.Song.Difficulty(
                                    playLevel: $0.1["playLevel"].intValue,
                                    ...
                                    multiLiveScoreMap: $0.1["multiLiveScoreMap"].map {
                                        (
                                            key: Int($0.0)!,
                                            value: SekaiAPI.Songs.Song.Difficulty.MultiLiveScore(
                                                musicID: $0.1["musicId"].intValue,
...
extension SekaiAPI.Songs {
    /// Represent simplified data of a song.
    public struct PreviewSong: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        /// A unique ID of song.
        public var id: Int
        /// Tag of song.
        ...
        internal init(
            ...
            bandID: Int,
            jacketImage: [String],
            musicTitle: SekaiAPI.LocalizedData<String>,
            publishedAt: SekaiAPI.LocalizedData<Date>,
            closedAt: SekaiAPI.LocalizedData<Date>,
        ...
        public struct Difficulty: Sendable, Hashable, SekaiCache.Cacheable {
            public var playLevel: Int
            public var publishedAt: SekaiAPI.LocalizedData<Date>? // String(JSON) -> Date(Swift)
            
            internal init(playLevel: Int, publishedAt: SekaiAPI.LocalizedData<Date>?) {
        ...
        public struct MusicVideoMetadata: Sendable, Hashable, SekaiCache.Cacheable {
    ...
    public struct Song: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        ...
        public var seq: Int
        public var musicTitle: SekaiAPI.LocalizedData<String>
        public var ruby: SekaiAPI.LocalizedData<String>
        public var phonetic: SekaiAPI.LocalizedData<String>
        public var lyricist: SekaiAPI.LocalizedData<String>
        public var composer: SekaiAPI.LocalizedData<String>
        public var arranger: SekaiAPI.LocalizedData<String>
        public var howToGet: SekaiAPI.LocalizedData<String>
        public var publishedAt: SekaiAPI.LocalizedData<Date> // String(JSON) -> Date(Swift)
        public var closedAt: SekaiAPI.LocalizedData<Date> // String(JSON) -> Date(Swift)
        ...
        internal init(
            ...
            seq: Int,
            musicTitle: SekaiAPI.LocalizedData<String>,
            ruby: SekaiAPI.LocalizedData<String>,
            phonetic: SekaiAPI.LocalizedData<String>,
            lyricist: SekaiAPI.LocalizedData<String>,
            composer: SekaiAPI.LocalizedData<String>,
            arranger: SekaiAPI.LocalizedData<String>,
            howToGet: SekaiAPI.LocalizedData<String>,
            publishedAt: SekaiAPI.LocalizedData<Date>,
            closedAt: SekaiAPI.LocalizedData<Date>,
            description: SekaiAPI.LocalizedData<String>,
            difficulty: [DifficultyType : Difficulty],
            length: Double,
            notes: [DifficultyType : Int],
            bpm: [DifficultyType : [BPM]],
        ...
        public struct Achievement: Sendable, Hashable, SekaiCache.Cacheable {
            public var musicID: Int
            public var achievementType: AchievementType
            public var reward: SekaiAPI.Item
            
            public enum AchievementType: String, Sendable, Hashable, SekaiCache.Cacheable {
        ...
        public struct Difficulty: Sendable, Hashable, SekaiCache.Cacheable {
            ...
            public struct MultiLiveScore: Sendable, Hashable, SekaiCache.Cacheable {
                public var musicID: Int
                ...
                public enum DifficultyType: String, Sendable, SekaiCache.Cacheable {
                    case daredemo
                    case standard
                    case grand
                    case legend
    ...
    public enum SongTag: String, CaseIterable, Sendable, Hashable, SekaiCache.Cacheable {
        case normal
        case anime
        case tieUp = "tie_up"
    }
    ...
    @frozen
    public enum DifficultyType: Int, Hashable, CaseIterable, SekaiCache.Cacheable {
        case easy = 0
        case normal
        case hard
        case expert
    ...
    @frozen
    public struct BPM: Sendable, Hashable, SekaiCache.Cacheable {
        public var bpm: Int
        public var start: Double
        public var end: Double
    }
    
    public enum Chart: Sendable, Hashable, SekaiCache.Cacheable {
        ...
        public struct BPMData: Sendable, Hashable, SekaiCache.Cacheable {
            public var bpm: Int
            public var beat: Double
        }
        public struct SystemData: Sendable, Hashable, SekaiCache.Cacheable {
            public var data: String
            public var beat: Double
        }
        public struct SingleData: Sendable, Hashable, SekaiCache.Cacheable {
            public var lane: Double
            public var beat: Double
            public var flick: Bool
            public var skill: Bool
        }
        public struct LongData: Sendable, Hashable, SekaiCache.Cacheable {
            public var connections: [Connection]
            
            public struct Connection: Sendable, Hashable, SekaiCache.Cacheable {
                public var lane: Double
                public var beat: Double
                public var flick: Bool
            }
        }
        public struct SlideData: Sendable, Hashable, SekaiCache.Cacheable {
            public var connections: [Connection]
        ...
        public struct DirectionalData: Sendable, Hashable, SekaiCache.Cacheable {
            public var beat: Double
            public var lane: Double
            ...
            @frozen
            public enum Direction: String, Sendable, Hashable, SekaiCache.Cacheable {
                case left = "Left"
                case right = "Right"
            }
        }
...
extension SekaiAPI.Songs.DifficultyType {
...
extension SekaiAPI.Songs.PreviewSong {
    public init(_ full: SekaiAPI.Songs.Song) {
        self.init(
            id: full.id,
            tag: full.tag,
            bandID: full.bandID,
...
extension SekaiAPI.Songs.Song {
    @inlinable
    public init?(id: Int) async {
        if let song = await SekaiAPI.Songs.detail(of: id) {
            self = song
        } else {
            return nil
        }
    ...
    @inlinable
    public init?(preview: SekaiAPI.Songs.PreviewSong) async {
