...
extension SekaiAPI.LoginCampaigns {
    /// Represent simplified data of login campaign.
    public struct PreviewCampaign: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        ...
        public var assetBundleName: SekaiAPI.LocalizedData<String>
        ...
        public var closedAt: SekaiAPI.LocalizedData<Date>
    }
    
    public struct Campaign: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        /// A unique ID of login campaign.
        public var id: Int
        /// Type of login campaign.
        public var loginBonusType: CampaignType
        ...
        public var details: SekaiAPI.LocalizedData<[Bonus]>
        
        /// Represent a bonus detail of login campaign.
        public struct Bonus: Sendable, Hashable, SekaiCache.Cacheable {
            ...
            public enum GrantType: String, Sendable, Hashable, SekaiCache.Cacheable {
                case present
            }
        }
    }
    ...
    public enum CampaignType: String, Sendable, Hashable, SekaiCache.Cacheable {
        case normal
        case event
        case birthday
        case rookie
...
extension SekaiAPI.LoginCampaigns.PreviewCampaign {
    public init(_ full: SekaiAPI.LoginCampaigns.Campaign) {
        self.init(
            id: full.id,
...
extension SekaiAPI.LoginCampaigns.Campaign {
    @inlinable
    public init?(id: Int) async {
        if let campaign = await SekaiAPI.LoginCampaigns.detail(of: id) {
            self = campaign
        } else {
            return nil
        }
    ...
    @inlinable
    public init?(preview: SekaiAPI.LoginCampaigns.PreviewCampaign) async {
