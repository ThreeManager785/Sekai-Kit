...
extension SekaiAPI.Cards {
    /// Represent simplified data of a card.
    public struct PreviewCard: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        /// A unique ID of card.
        public var id: Int
        ...
        public var cardName: SekaiAPI.LocalizedData<String>
        /// Localized release date of card.
        public var releasedAt: SekaiAPI.LocalizedData<Date>
    ...
    public struct Card: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        /// A unique ID of card.
        public var id: Int
        /// ID of related character to this card.
        public var characterID: Int
        ...
        public var gachaText: SekaiAPI.LocalizedData<String>
        /// Localized title of card.
        public var cardName: SekaiAPI.LocalizedData<String>
        /// Localized release date of card.
        public var releasedAt: SekaiAPI.LocalizedData<Date>
        /// Localized skill name.
        public var skillName: SekaiAPI.LocalizedData<String>
        /// ID of skill associated to this card.
        public var skillID: Int
        /// Localized source of this card.
        public var source: SekaiAPI.LocalizedData<Set<CardSource>>
        /// Type of card.
        public var type: CardType
        ...
        internal init(
            ...
            characterID: Int,
            rarity: Int,
            attribute: SekaiAPI.Attribute,
            levelLimit: Int,
            resourceSetName: String,
            sdResourceName: String,
            episodes: [CardEpisode],
            costumeID: Int,
            gachaText: SekaiAPI.LocalizedData<String>,
            cardName: SekaiAPI.LocalizedData<String>,
            releasedAt: SekaiAPI.LocalizedData<Date>,
            skillName: SekaiAPI.LocalizedData<String>,
            skillID: Int,
            source: SekaiAPI.LocalizedData<Set<CardSource>>,
            type: CardType,
            animation: Animation?,
            stat: CardStat
        ) {
        ...
        public enum CardSource: Sendable, Hashable, SekaiCache.Cacheable {
        ...
        public struct Animation: Sendable, Hashable, SekaiCache.Cacheable {
    ...
    public enum CardType: String, Sendable, CaseIterable, Hashable, SekaiCache.Cacheable {
        case initial
        case permanent
        case event
        case limited
    ...
    public struct CardEpisode: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        public var id: Int
        ...
        @frozen
        public enum EpisodeType: String, Hashable, SekaiCache.Cacheable {
            case animation
            case standard
            case memorial
        }
        public struct Resource: Sendable, Hashable, SekaiCache.Cacheable {
            ...
            public enum ResourceType: String, Sendable, Hashable, SekaiCache.Cacheable {
                case item
                case star
            }
        }
    ...
    public struct Stat: Sendable, Hashable, SekaiCache.Cacheable {
    ...
    ///     - ``Swift/Dictionary/calculated(level:rarity:masterRank:viewedStoryCount:trained:)``
    ///     - ``Swift/Dictionary/maximumValue(rarity:)``
    public enum StatKey: Sendable, Hashable, SekaiCache.Cacheable {
        case level(Int)
        case episodes
        case training
    }
...
extension SekaiAPI.Cards.PreviewCard {
    public init(_ full: SekaiAPI.Cards.Card) {
        self.init(
            id: full.id,
...
extension SekaiAPI.Cards.Card {
    @inlinable
    public init?(id: Int) async {
        if let card = await SekaiAPI.Cards.detail(of: id) {
            self = card
        } else {
            return nil
        }
    ...
    @inlinable
    public init?(preview: SekaiAPI.Cards.PreviewCard) async {
        await self.init(id: preview.id)
    }
}

extension SekaiAPI.Cards.Stat: AdditiveArithmetic {
...
extension SekaiAPI.Cards.CardStat {
    ...
    @inlinable
    public func forMinimumLevel() -> SekaiAPI.Cards.Stat? {
    ...
    @inlinable
    public func forMaximumLevel() -> SekaiAPI.Cards.Stat? {
    ...
    ///   ``SekaiAPI/Card/CardStat`` itself doesn't store rarity
    ...
    public func calculated(
        ...
        var result = SekaiAPI.Cards.Stat(performance: 50, technique: 50, visual: 50) * rarity * masterRank
    ...
    /// - Returns: Calculated stat, nil if failed to calculate.
    @inlinable
    public func maximumValue(rarity: Int) -> SekaiAPI.Cards.Stat? {
...
extension SekaiAPI.Cards.CardEpisode {
    public func standardized() -> SekaiAPI.Story {
        return SekaiAPI.Story(
