...
extension SekaiAPI.Degrees {
    /// Represent information of a degree.
    public struct Degree: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        /// A unique ID of degree.
        public var id: Int
        /// Localized type of degree.
        public var degreeType: SekaiAPI.LocalizedData<DegreeType>
        /// Localized icon image name, used for combination of resource URLs.
        public var iconImageName: SekaiAPI.LocalizedData<String>
        /// Localized base image name, used for combination of resource URLs.
        public var baseImageName: SekaiAPI.LocalizedData<String>
        /// Localized rank of degree.
        public var rank: SekaiAPI.LocalizedData<String>
        /// Localized name of degree.
        public var degreeName: SekaiAPI.LocalizedData<String>
        
        /// Represent type of degrees
        public enum DegreeType: String, Sendable, SekaiCache.Cacheable {
            case normal
