...
extension SekaiAPI.Skills {
    /// Represent a skill of card.
    public struct Skill: Sendable, Identifiable, Equatable, Hashable, SekaiCache.Cacheable {
        ...
        /// - SeeAlso:
        ///     - ``description``
        ///     - ``SekaiAPI/LocalizedData/map(_:)``
        public var simpleDescription: SekaiAPI.LocalizedData<String>
        ...
        ///     use ``replacedDescription(with:)`` to let SekaiKit do this,
        ...
        public struct ActivationEffect: Sendable, Equatable, Hashable, SekaiCache.Cacheable {
            ...
            public enum ActivateConditionType: String, Sendable, Hashable, SekaiCache.Cacheable {
                case pure = "PURE"
                case cool = "COOL"
                case happy = "HAPPY"
            ...
            public enum ActivateEffectType: String, Sendable, Hashable, SekaiCache.Cacheable {
                case score
                case judge
            ...
            public struct ActivateEffect: Sendable, Equatable, Hashable, SekaiCache.Cacheable {
                ...
                public enum ValueType: String, Sendable, Hashable, SekaiCache.Cacheable {
                    case rate
                    case realValue = "real_value"
                }
                public enum ActivateCondition: String, Sendable, Hashable, SekaiCache.Cacheable {
                    case none
                    case good
                    case perfect
                }
        ...
        public struct OnceEffect: Sendable, Equatable, Hashable, SekaiCache.Cacheable {
            ...
            public enum OnceEffectType: String, Sendable, Hashable, SekaiCache.Cacheable {
                case life
            }
            public enum ValueType: String, Sendable, Hashable, SekaiCache.Cacheable {
                case realValue = "real_value"
            }
            public enum ConditionLifeType: String, Sendable, Hashable, SekaiCache.Cacheable {
...
extension SekaiAPI.Skills.Skill {
    public func replacedDescription(with replacement: (String, String?)) -> SekaiAPI.LocalizedData<String> {
    ...
    public var maximumDescription: SekaiAPI.LocalizedData<String> {
