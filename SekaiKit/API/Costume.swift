...
extension SekaiAPI.Costumes {
    /// Represent simplified data of a costume.
    public struct PreviewCostume: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
    ...
    public struct Costume: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        /// A unique ID of costume.
        public var id: Int
        /// ID of related character to this costume.
        public var characterID: Int
...
extension SekaiAPI.Costumes.PreviewCostume {
    public init(_ full: SekaiAPI.Costumes.Costume) {
        self.init(
            id: full.id,
...
extension SekaiAPI.Costumes.Costume {
    @inlinable
    public init?(id: Int) async {
        if let costume = await SekaiAPI.Costumes.detail(of: id) {
            self = costume
        } else {
            return nil
        }
    ...
    @inlinable
    public init?(preview: SekaiAPI.Costumes.PreviewCostume) async {
