...
extension SekaiAPI {
    ...
    public enum Misc {
        ...
        public static func eventStoryAsset(eventID: Int, scenarioID: String, locale: SekaiAPI.Locale) async -> StoryAsset? {
        ...
        public static func mainStoryAsset(scenarioID: String, locale: SekaiAPI.Locale) async -> StoryAsset? {
        ...
        public static func bandStoryAsset(bandID: Int, scenarioID: String, locale: SekaiAPI.Locale) async -> StoryAsset? {
        ...
        public static func cardStoryAsset(resourceSetName: String, scenarioID: String, locale: SekaiAPI.Locale) async -> StoryAsset? {
        ...
        public static func actionSetStoryAsset(actionSetID: Int, locale: SekaiAPI.Locale) async -> StoryAsset? {
        ...
        public static func afterLiveStoryAsset(talkID: Int, scenarioID: String, locale: SekaiAPI.Locale) async -> StoryAsset? {
...
// We declare extension of `SekaiAPI` instead of `SekaiAPI.Misc`
...
extension SekaiAPI {
    public struct Item: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        ...
        public enum ItemType: String, Sendable, Hashable, SekaiCache.Cacheable {
            case item
            case star
            case coin
    ...
    public struct Story: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
...
extension SekaiAPI.Story {
    public init(_ eventStory: SekaiAPI.Events.Event.Story) {
        self.init(
...
// extension of `SekaiAPI.Misc`
extension SekaiAPI.Misc {
    public struct ItemText: Sendable, Hashable, SekaiCache.Cacheable {
        public var name: SekaiAPI.LocalizedData<String>
        public var type: ItemType?
        public var resourceID: Int
        
        internal init(name: SekaiAPI.LocalizedData<String>, type: ItemType?, resourceID: Int) {
            self.name = name
            self.type = type
    ...
    public struct BandStory: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        public var id: Int
        public var bandID: Int
        public var chapterNumber: Int
        public var mainTitle: SekaiAPI.LocalizedData<String>
        public var subTitle: SekaiAPI.LocalizedData<String>
        public var publishedAt: SekaiAPI.LocalizedData<Date>
        public var stories: [SekaiAPI.Story]
    }
    public struct AfterLiveTalk: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        public var id: Int
        public var scenarioID: String
        public var description: SekaiAPI.LocalizedData<String>
    }
    
    public struct Area: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        public var id: Int
        public var areaName: SekaiAPI.LocalizedData<String>
    }
    public struct ActionSet: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        public var id: Int
        public var areaID: Int
        public var characterIDs: [Int]
        public var actionSetType: ActionSetType
        
        public enum ActionSetType: String, CaseIterable, Sendable, Hashable, SekaiCache.Cacheable {
            case normal
            case birthday
    ...
    public struct StoryAsset: Sendable, Hashable, SekaiCache.Cacheable {
        ...
        public struct AppearCharacter: Sendable, Hashable, SekaiCache.Cacheable {
            public var characterID: Int
            public var costumeType: String
        }
        public struct Snippet: Sendable, Hashable, SekaiCache.Cacheable {
            ...
            public enum ActionType: Int, Sendable, Hashable, SekaiCache.Cacheable {
                case none
                case talk
                case layout
                case input
        ...
        public struct TalkData: Sendable, Hashable, SekaiCache.Cacheable {
            ...
            public struct TalkCharacter: Sendable, Hashable, SekaiCache.Cacheable {
                public var characterID: Int
            }
            public struct Motion: Sendable, Hashable, SekaiCache.Cacheable {
                public var characterID: Int
                public var motionName: String
                public var expressionName: String
                public var timingSyncValue: String
            }
            public struct Voice: Sendable, Hashable, SekaiCache.Cacheable {
                public var characterID: Int
                public var voiceID: String
                public var volume: Double
            }
        }
        public struct LayoutData: Sendable, Hashable, SekaiCache.Cacheable {
            ...
            public enum LayoutType: Int, Sendable, Hashable, SekaiCache.Cacheable {
                case none
                case move
                case appear
                case hide
            ...
            public enum Side: Int, Sendable, Hashable, SekaiCache.Cacheable {
                case none
                case left
                case leftOver
                case leftInside
            ...
            public enum DepthType: Int, Sendable, Hashable, SekaiCache.Cacheable {
                case notSet
                case front
                case back
            }
            public enum MoveSpeedType: Int, Sendable, Hashable, SekaiCache.Cacheable {
                case normal
                case fast
                case slow
            }
        }
        public struct SpecialEffectData: Sendable, Hashable, SekaiCache.Cacheable {
            ...
            public enum EffectType: Int, Sendable, Hashable, SekaiCache.Cacheable {
                case none
                case blackIn
                case blackOut
                case whiteIn
        ...
        public struct SoundData: Sendable, Hashable, SekaiCache.Cacheable {
    ...
    public struct PlayerProfile: Sendable, Hashable, SekaiCache.Cacheable {
        ...
        public var userMusicClearInfo: [SekaiAPI.Songs.DifficultyType: MusicClearInfo]
        
        public struct Flags: Sendable, OptionSet, Hashable, SekaiCache.Cacheable {
        ...
        public struct Situation: Sendable, Hashable, SekaiCache.Cacheable {
            ...
            public struct AppendParameter: Sendable, Hashable, SekaiCache.Cacheable {
                public var stat: SekaiAPI.Cards.Stat // Int<performance|technique|visual>(JSON) -> Stat(Swift)
                public var characterPotentialStat: SekaiAPI.Cards.Stat // Int<characterPotential.+>(JSON) -> Stat(Swift)
                public var characterBonusStat: SekaiAPI.Cards.Stat // Int<characterPotential.+>(JSON) -> Stat(Swift)
            }
        }
        
        public struct HighScoreRating: Sendable, Hashable, SekaiCache.Cacheable {
            ...
            public struct HighScoreMusic: Sendable, Hashable, SekaiCache.Cacheable {
                public var musicID: Int
                public var difficulty: SekaiAPI.Songs.DifficultyType
                public var rating: Int
            }
        }
        
        public struct UserDeck: Sendable, Hashable, SekaiCache.Cacheable {
        ...
        public struct ProfileSituation: Sendable, Hashable, SekaiCache.Cacheable {
            public var userID: Int
            public var situationID: Int
            public var illust: String
        ...
        public struct MusicClearInfo: Sendable, Hashable, SekaiCache.Cacheable {
    ...
    public struct DecoFrame: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        public var id: Int
        public var assetBundleName: String
        public var decoFrameName: SekaiAPI.LocalizedData<String>
    }
    public struct DecoPin: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        public var id: Int
        public var assetBundleName: String
        public var decoPinName: SekaiAPI.LocalizedData<String>
    }
    public struct DecoPinSet: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        public var id: Int
        public var assetBundleName: String
        public var decoPinSetName: SekaiAPI.LocalizedData<String>
    }
    
    public struct Stamp: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        public var id: Int
        public var imageName: String
    }
    
    public struct GameLaneSkin: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        public var id: Int
        public var assetBundleName: String
        public var skinName: SekaiAPI.LocalizedData<String>
    }
}

extension SekaiAPI.Misc.PlayerProfile {
    internal init(parsing json: JSON) {
        var flagsValue: UInt16 = 0
        if json["publishTotalDeckPowerFlg"].boolValue {
            flagsValue |= Flags.publishTotalDeckPower.rawValue
        }
        if json["publishBandRankFlg"].boolValue {
            flagsValue |= Flags.publishBandRank.rawValue
        }
        if json["publishMusicClearedFlg"].boolValue {
            flagsValue |= Flags.publishMusicCleared.rawValue
        }
        if json["publishMusicFullComboFlg"].boolValue {
            flagsValue |= Flags.publishMusicFullCombo.rawValue
        }
        if json["publishHighScoreRatingFlg"].boolValue {
            flagsValue |= Flags.publishHighScoreRating.rawValue
        }
        if json["publishUserIdFlg"].boolValue {
            flagsValue |= Flags.publishUserID.rawValue
        }
        if json["searchableFlg"].boolValue {
            flagsValue |= Flags.searchable.rawValue
        }
        if json["publishUpdatedAtFlg"].boolValue {
            flagsValue |= Flags.publishUpdatedAt.rawValue
        }
        if json["friendApplicableFlg"].boolValue {
            flagsValue |= Flags.friendApplicable.rawValue
        }
        if json["publishMusicAllPerfectFlg"].boolValue {
            flagsValue |= Flags.publishMusicAllPerfect.rawValue
        }
        if json["publishDeckRankFlg"].boolValue {
            flagsValue |= Flags.publishDeckRank.rawValue
        }
        if json["publishStageChallengeAchievementConditionsFlg"].boolValue {
            flagsValue |= Flags.publishStageChallengeAchievementConditions.rawValue
        }
        if json["publishStageChallengeFriendRankingFlg"].boolValue {
            flagsValue |= Flags.publishStageChallengeFriendRanking.rawValue
        }
        if json["publishCharacterRankFlg"].boolValue {
            flagsValue |= Flags.publishCharacterRank.rawValue
        }
        
        func highScoreMusic(for key: String) -> [HighScoreRating.HighScoreMusic] {
            json["userHighScoreRating"][key]["entries"].map {
                .init(
        ...
        let userMusicClearInfo = json["userMusicClearInfoMap"]["entries"].map {
            (key: SekaiAPI.Songs.DifficultyType(rawStringValue: $0.0) ?? .easy,
        ...
        }.reduce(into: [SekaiAPI.Songs.DifficultyType: MusicClearInfo]()) { $0.updateValue($1.value, forKey: $1.key) }
        ...
        self.init(
            ...
            degree: json["degree"].intValue,
            introduction: json["introduction"].stringValue,
            flags: .init(rawValue: flagsValue),
            mainDeckUserSituations: json["mainDeckUserSituations"]["entries"].map {
                .init(
            ...
            mainUserDeck: .init(
                deckID: json["mainUserDeck"]["deckId"].intValue,
                deckName: json["mainUserDeck"]["deckName"].stringValue,
                leader: json["mainUserDeck"]["leader"].intValue,
                member1: json["mainUserDeck"]["member1"].intValue,
                member2: json["mainUserDeck"]["member2"].intValue,
                member3: json["mainUserDeck"]["member3"].intValue,
                member4: json["mainUserDeck"]["member4"].intValue
            ),
            userProfileSituation: .init(
                userID: Int(json["userProfileSituation"]["userId"].stringValue) ?? 0,
                situationID: json["userProfileSituation"]["situationId"].intValue,
                illust: json["userProfileSituation"]["illust"].stringValue,
                viewProfileSituationStatus: json["userProfileSituation"]["viewProfileSituationStatus"].stringValue
            ),
            userProfileDegree: [
                json["userProfileDegreeMap"]["entries"]["first"]["degreeId"].int,
                json["userProfileDegreeMap"]["entries"]["second"]["degreeId"].int
            ],
