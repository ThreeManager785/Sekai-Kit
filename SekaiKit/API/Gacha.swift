...
extension SekaiAPI.Gachas {
    /// Represent simplified data of gacha.
    public struct PreviewGacha: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
    ...
    public struct Gacha: Sendable, Identifiable, Hashable, SekaiCache.Cacheable {
        ...
        /// - SeeAlso:
        ///     - ``CardDetail``
        public var details: SekaiAPI.LocalizedData<[Int: CardDetail]>
        ...
        /// - SeeAlso:
        ///     - ``Rate``
        public var rates: SekaiAPI.LocalizedData<[Int: Rate]>
        ...
        public var annotation: SekaiAPI.LocalizedData<String>
        /// Localized period text of gacha.
        public var gachaPeriod: SekaiAPI.LocalizedData<String>
        /// Type of gacha.
        public var type: GachaType
        /// IDs of new cards in this gacha.
        ///
        ...
        public struct CardDetail: Sendable, Hashable, SekaiCache.Cacheable {
            /// Rarity of card.
        ...
        public struct Rate: Sendable, Hashable, SekaiCache.Cacheable {
            /// Rate.
        ...
        public struct PaymentMethod: Sendable, Hashable, SekaiCache.Cacheable {
            ...
            public enum Method: String, Sendable, Hashable, SekaiCache.Cacheable {
                case free
            ...
            public enum Behavior: String, Sendable, Hashable, SekaiCache.Cacheable {
                case normal
        ...
        public struct Information: Sendable, Hashable, SekaiCache.Cacheable {
            /// Localized description of gacha.
            public var description: SekaiAPI.LocalizedData<String>
            /// Localized term of gacha.
            public var term: SekaiAPI.LocalizedData<String>
            /// Localized new member info of gacha.
            public var newMemberInfo: SekaiAPI.LocalizedData<String>
            /// Localized notice of gacha.
            public var notice: SekaiAPI.LocalizedData<String>
        }
    }
    
    /// Represent type of gacha.
    public enum GachaType: String, Sendable, CaseIterable, Hashable, SekaiCache.Cacheable {
        case free
        case permanent
        case miracle
        case limited
...
extension SekaiAPI.Gachas.PreviewGacha {
    public init(_ full: SekaiAPI.Gachas.Gacha) {
        self.init(
            id: full.id,
...
extension SekaiAPI.Gachas.Gacha {
    @inlinable
    public init?(id: Int) async {
        if let gacha = await SekaiAPI.Gachas.detail(of: id) {
            self = gacha
        } else {
            return nil
        }
    ...
    @inlinable
    public init?(preview: SekaiAPI.Gachas.PreviewGacha) async {
