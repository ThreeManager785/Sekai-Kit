...
extension SekaiAPI {
    public enum Station {
        ...
        /// let task = Task {
        ///     do {
        ///         try await SekaiAPI.Station.receiveRooms { newRooms in
                            ...
                            if json["status"].stringValue == "success" {
                                var result = UserInformation(
                                    ...
                                    bestdoriProfiles: json["response"]["bandori_profile"].map {
                                        (key: $0.0,
                                         value: $0.1.map {
                                            SekaiAPI.Misc.PlayerProfile(parsing: $0.1)
                                        })
                                    }.reduce(into: [SekaiAPI.Locale: [SekaiAPI.Misc.PlayerProfile]]()) {
                                        $0.updateValue(
                                            $1.value,
...
extension SekaiAPI.Station {
    ...
    public struct UserInformation: Sendable, Identifiable, Hashable {
        ...
        public var bestdoriProfiles: [SekaiAPI.Locale: [SekaiAPI.Misc.PlayerProfile]]?
...
extension SekaiAPI.Station.Room {
...
extension SekaiAPI.Station.Room.Source {
    internal init(parsing json: JSON) {
