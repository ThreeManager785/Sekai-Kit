...
extension SekaiAPI.Constellation {
    @inline(never)
...
extension SekaiAPI.Cards.CardType {
    @inline(never)
    public var localizedString: String {
        NSLocalizedString("card" + self.rawValue, bundle: #bundle, comment: "")
    }
}
extension SekaiAPI.Cards.CardEpisode.EpisodeType {
    @inline(never)
    public var localizedString: String {
...
extension SekaiAPI.Characters.Character.Profile.Part {
    @inline(never)
    public var localizedString: String {
        switch self {
...
extension SekaiAPI.Gachas.GachaType {
    @inline(never)
    public var localizedString: String {
        NSLocalizedString("gacha" + self.rawValue, bundle: #bundle, comment: "")
    }
}
extension SekaiAPI.Gachas.Gacha.PaymentMethod.Method {
    @inline(never)
    public var localizedString: String {
        switch self {
...
extension SekaiAPI.Gachas.Gacha.PaymentMethod.Behavior {
    @inline(never)
    public var localizedString: String {
        switch self {
        case .normal: String()
...
extension SekaiAPI.LoginCampaigns.CampaignType {
    @inline(never)
    public var localizedString: String {
...
extension SekaiAPI.Misc.ActionSet.ActionSetType {
    @inline(never)
    public var localizedString: String {
...
extension SekaiAPI.Posts.Post.StoryMetadata.AgeRating {
    @inline(never)
    public var localizedString: String {
        switch self {
...
extension SekaiAPI.Songs.SongTag {
    @inline(never)
    public var localizedString: String {
